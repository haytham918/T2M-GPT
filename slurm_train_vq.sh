...
#SBATCH --output=output/VQVAE_R3_1/eval_log.txt
#SBATCH --error=output/VQVAE_R3_1/eval_error.txt
...
--loss_ergo 0.1 \
--loss_ergo_mode same \
--note "R3-1-same-0.1ergoloss-LRELU" \
--out-dir "/scratch/shdpm_root/shdpm0/wenleyan/T2M_exp/Round3/VQVAE_1" \
